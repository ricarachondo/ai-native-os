...
- `templates/skills/functional-site-audit/` — reverse-engineer a reference product's flows into a functional analysis + actionable PRD. Ships the packaged skill, 5 extraction scripts, and the long-form playbook in `references/`.
